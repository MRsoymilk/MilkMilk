...
namespace MilkMilk.Internal
{
    public static class Logger
    {
        ...
        private static readonly Action<ILogger, string, int, Exception> _quote_delete_fail;
        static Logger()
        {
            ...
            _quote_delete_fail = LoggerMessage.Define<string, int>(
                            LogLevel.Error,
                            new EventId(4, nameof(QuoteDeleteFail)),
                            "xxxxx quote delete faile (Error = '{error}' id = '{id}')");
        }
        ...
        public static void QuoteDeleteFail(this ILogger logger, string error, int id)
        {
            _quote_delete_fail(logger, error, id, null);
        }
    }
}
